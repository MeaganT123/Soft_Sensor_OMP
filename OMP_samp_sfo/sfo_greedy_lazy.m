...
% BEM: Algorithm stops selecting elements once the maginal gain becomes negative
% BEM: I need to modify the code to allow adding elements of negative gain
% BEM: Set greed_tolerance to a lage negative number (from 1e-6 to -1e+10)
TOL = sfo_opt_get(opt,'greedy_tolerance',-1e+10);
